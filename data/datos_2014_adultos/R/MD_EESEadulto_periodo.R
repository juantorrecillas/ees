#################################################################################
# Nombre del programa:	MD_EESEadulto_2014.R                                          
# Autor:              	INE
# Version:            	4.1
# Última modificación: 	15 septiembre 2017
#                                                                                
# Descripción: 
#	Este programa procesa un fichero de microdatos (md_EESEadulto_2014.txt)
#   a partir de un fichero de metadatos (dr_EESEadulto_2014.xlsx) que contiene 
#   el diseño de registro del archivo de microdatos. 
#     EESEadulto.: Operación estadística
#     2014: Año(s) de producción de los datos
#
# Entrada:                                                           
#     - Diseño de registro: 	dr_EESEadulto_2014.xlsx
#     - Archivo de microdatos: 	md_EESEadulto_2014.txt
# Salida: 
...
fichero_micro <- "md_EESEadulto_2014.txt"
fichero_meta  <- "dr_EESEadulto_2014.xlsx"
